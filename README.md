...
- Here I will explain the process of making a bootable USB drive. So be patience:
  ...
  - Open "Disk Utility" and format your USB pendrive according to [this](https://github.com/md-siam/Hackintosh_EliteBook_Folio_9470m/blob/master/images/USB_Formatting.png) configuration.
